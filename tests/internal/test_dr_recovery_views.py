...
@override_settings(DR_WORKSPACE_RECOVERY_ENABLED=True)
class TestRecoverWorkspaceEventsEndpoint(TestCase):
    ...
    @override_settings(DR_WORKSPACE_RECOVERY_ENABLED=False)
...
class TestRecoverWorkspaceEventsTask(TestCase):
    ...
    def test_task_returns_early_when_disabled(self):
        """Task returns message when DR_WORKSPACE_RECOVERY_ENABLED is False."""
        ...
        self.assertEqual(result["message"], "DR recovery disabled (DR_WORKSPACE_RECOVERY_ENABLED=False)")
